...
camera_width=640
camera_height=480
l_depth_camera_no=335122272049
r_depth_camera_no=323622271191
...
sudo chmod a+rw /dev/video*
    ...
    source /opt/ros/jazzy/setup.bash && cd $SCRIPT_DIR/../install/sensor_tools/share/sensor_tools/scripts/ && chmod 777 usb_camera.py
if [ -n "$1" ]; then
